      ...
      if (specialProp) {
        ...
        if (isTransformRelated) {
          ...
          if (!transformPropTween) {
            ...
            transformPropTween = this._pt = new PropTween(this._pt, style2, _transformProp$1, 0, 1, cache2.renderTransform, cache2, 0, -1);
...
class Animate {
  advance(t2) {
    ...
    if (this.duration && this.easing) {
      this.currentTime += t2;
      const i = clamp2(0, this.currentTime / this.duration, 1);
      e = i >= 1;
...
class Dimensions {
  constructor({ wrapper: t2, content: e, autoResize: i = true, debounce: s = 250 } = {}) {
    ...
    this.wrapper = t2, this.content = e, i && (this.debouncedResize = function debounce(t3, e2) {
      let i2;
      return function() {
...
class Lenis {
  ...
  scrollTo(t2, { offset: e = 0, immediate: i = false, lock: s = false, duration: o = this.options.duration, easing: n = this.options.easing, lerp: r = this.options.lerp, onStart: l, onComplete: h, force: a = false, programmatic: c = true, userData: u = {} } = {}) {
    if (!this.isStopped && !this.isLocked || a) {
      ...
      if ("number" == typeof t2 && (t2 += e, t2 = Math.round(t2), this.options.infinite ? c && (this.targetScroll = this.animatedScroll = this.scroll) : t2 = clamp2(0, t2, this.limit), t2 !== this.targetScroll)) {
...
shorts.forEach(function(slide2) {
  const videoblock = slide2.querySelector(".shorts-block__video");
  const video = slide2.querySelector(".shorts-block-video");
  const playButton = slide2.querySelector(".shorts-block__btn");
...
if (menuLinks.length > 0) {
  ...
  var onMenuLinkClick2 = onMenuLinkClick;
